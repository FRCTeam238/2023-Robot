...
public class FloorTippedHeight extends ParallelCommandGroup {
  ...
  public FloorTippedHeight() { 
    Command ElevatorCube = new ElevatorProfile(new MotionProfile.State(RobotMap.ElevatorParameters.cubeFloor, 0), "FloorCube");
    Command ElevatorCone = new ElevatorProfile(new MotionProfile.State(RobotMap.ElevatorParameters.tippedConeFloor, 0), "FloorTipped");
