...
public class SingleSubHeight extends ParallelCommandGroup {
    ...
    public SingleSubHeight() {
        Command ElevatorCone = new ElevatorProfile(new MotionProfile.State(RobotMap.ElevatorParameters.singleSubCone, 0), "SingleSubCone");
        Command ElevatorCube = new ElevatorProfile(new MotionProfile.State(RobotMap.ElevatorParameters.cubeFloor, 0), "SingleSubCube");
